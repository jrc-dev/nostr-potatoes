...
const { useServices, Nostr } = require('stremio/services');
...
const Intro = ({ queryParams }) => {
    ...
    const loginWithNostr = React.useCallback(async () => {
        ...
        <div className={styles['intro-container']}>
            ...
            <div className={styles['content-container']}>
                ...
                <div className={styles['options-container']}>
                    ...
                    <Button className={classnames(styles['form-button'], styles['nostr-button'])} onClick={loginWithNostr}>
                        <Image className={styles['icon-nostr']}
                            src={require('/images/nostr_logo_wht.png')}
                            alt={' '}
                        />
                        <div className={styles['label']}>Continue with NOSTR</div>
                    </Button>
                    {
                        state.form === SIGNUP_FORM ?
