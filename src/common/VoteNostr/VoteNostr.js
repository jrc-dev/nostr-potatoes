...
const VoteNostr = ({ className, id, name, year, background, closeVoteModal }) => {
    ...
    const handleChangePostReview = (event) => {
        setChecked(!checked);
    };
    ...
    return (
        <div className={classnames(className, styles['share-prompt-container'])}>
            ...
            <div className={styles['buttons-container']}>
                <Button className={classnames(styles['button-container'], styles['uninstall-button-container'])} title={'Nostr'} onClick={handleRemoveVoteClick} disabled={rating == 0 || voting || !reviewed} title={'Remove rating'}>
