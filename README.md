...
- **Sub-Protocol:** Build your own client application, [Nostrassic Park](https://github.com/jrc-dev/nostrassic-park).
...
- [ ] **Ratings Main Page:** Having cache, it will be possible to view the rates on the main page.
